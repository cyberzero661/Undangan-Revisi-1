      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              Platform undangan digital interaktif 100% gratis. Buat undangan indah untuk momen spesialmu tanpa biaya apapun.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            &copy; 2026 Undangkuy. Dibuat dengan{" "}
            <Heart className="w-4 h-4 inline text-red-500 fill-red-500" /> di Indonesia
          </p>
